<template>
  <div class="automation">
    <NavigationInAutomation
      :area-class="navigationInAutomationData.areaClass"
      :left="navigationInAutomationData.left"
      :right="navigationInAutomationData.right"
      :down-to-scroll="navigationInAutomationData.downToScroll"
    ...
    <InfoBlockGrid :data="infoBlockGridAutomationInclude">
      <InfoBlockItem
        v-for="(item, key) in infoBlockListAutomationInclude"
        :key="key"
        :data="item"
      />
    </InfoBlockGrid>
    ...
    <!--    </AccordionSimple>-->
    <HorizonList :data="horizonListData"/>
    <SectionTitle :data="sectionTitleBegin"/>

    <PortOrder :data="beginBlock"/>
    <FormBlock/>
    <PresentationBlock/>
    <SectionTitle :data="sectionTitleAutomation"/>
...
import NavigationInAutomation from '~/components/common/NavigationInAutomation';
...
export default {
  ...
  data() {
    return {
      ...
      projectListTags: [
        'XRM', 'ERP', 'Автоматизация',
      ],

      navigationInAutomationData: {
        areaClass: ['auto-triangle'],
        // title: 'Автоматизация бизнеса',
        left: {
          title: 'CRM<br>система',
          icon: '/img/ixon_crm.svg',
          link: '/crm',
        },
        right: {
          title: 'ERP<br>система',
          icon: '/img/ixon_erp.svg',
          link: '/erp',
        },
        downToScroll: '.auto-to-scroll',
      },
      ...
      sectionTitle: {
        areaClass: 'max-width-20',
        title: 'Автоматизация бизнеса производится<br> по следующим направлениям',
      },
      ...
      infoBlockList: [
        {
          text: 'Генерация потока клиентов',
          textClass: 'text-primary automate-text',
          iconName: 'generate',
        },
        {
        ...
        {
          text: 'Производство продукта',
          textClass: 'text-primary automate-text',
          iconName: 'make',
        },
        {
          text: 'Внутренние бизнес-процессы',
          textClass: 'text-primary automate-text',
          iconName: 'process',
        },
      ],
      ...
      quotationBlock: {
        text: '<p>Система может затрагивать один или несколько пунктов. Сначала автоматизируются наиболее важные процессы. Система может включать:</p>',
      },

      infoBlockGridAutomationInclude: {
        column: '4', // Количество столбцов
        gap: '75', // Расстояние между столбцами
      },

      infoBlockListAutomationInclude: [
        {
          text: 'сайт, системы коммуникации и CRM',
          textClass: 'text-primary text-center-xs',
          iconName: 'ticks',
        },
        {
          text: 'постановка и контроль задач',
          textClass: 'text-primary text-center-xs',
          iconName: 'ticks',
        },
        {
          text: 'контроль <span style="white-space: nowrap">бизнес-процессов</span>',
          textClass: 'text-primary text-center-xs',
          iconName: 'ticks',
        },
        {
          text: 'анализ эффективности организации',
          textClass: 'text-primary text-center-xs',
          iconName: 'ticks',
        },
      ],
      ...
      sectionTitleAdvantage: {
        areaClass: 'max-width-20',
        title: 'Преимущества единого комплексного программно-аппаратного решения',
      },
