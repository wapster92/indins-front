<!-- eslint-disable -->
<template>
    <div class="swiper-area swiper-for-icons swiper-projects">
      <div class="swiper-projects__container">
        ...
        <div
            slot="pagination"
            class="swiper-pagination swiper-points swiper-first"
        />
        <div
            slot="button-prev"
            @click="prev()"
            class="swiper-arrow-btn swiper-arrow-prev swiper-arrow-prev-first"
        >
          <svg
              version="1.1"
        ...
        <div
            slot="button-next"
            @click="next()"
            class="swiper-arrow-btn swiper-arrow-next swiper-arrow-next-first"
        >
          <svg
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
  ...
  data() {
    return {
      swiperOptions: {
        ...
        spaceBetween: 20,
        navigation: {
          nextEl: '.swiper-arrow-next-first',
          prevEl: '.swiper-arrow-prev-first',
        },
        pagination: {
          el: '.swiper-first',
        },
